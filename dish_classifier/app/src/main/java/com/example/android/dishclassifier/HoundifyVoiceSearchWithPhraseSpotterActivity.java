...
public class HoundifyVoiceSearchWithPhraseSpotterActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        // A one-time initialization in onCreate
        houndify = Houndify.get(this);
        houndify.setClientId("v86MSfARos_qF981hicBlA==");
        houndify.setClientKey("yQW_c7M51opcqFlhJ-27v1HP0AbJCHscRd09mKqi5zXLWhkFo4eqInL7TXImQ-XCZ_5lILr4Nkw91iaVbzDlZQ==");
        ...
        //Registers an intercepter that allows you to modify the VoiceSearch.Builder
